...
router.post('/:id/campaigns', auth_middleware_1.authenticateToken, (req, res) => {
    res.status(201).json({
        success: true,
...
router.get('/:id/campaigns', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/members', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.put('/:id/members/:memberId', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.delete('/:id/members/:memberId', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/campaigns/:campaignId/vendors', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/campaigns/:campaignId/trees/bulk', auth_middleware_1.authenticateToken, upload_middleware_1.uploadMiddleware.single('csvFile'), (req, res) => {
    res.json({
        success: true,
