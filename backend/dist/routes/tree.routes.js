...
router.post('/', auth_middleware_1.authenticateToken, upload_middleware_1.uploadMiddleware.single('photo'), (req, res) => {
    res.status(201).json({
        success: true,
...
router.get('/adoptable', auth_middleware_1.optionalAuth, (req, res) => {
...
router.get('/:id', auth_middleware_1.optionalAuth, (req, res) => {
    res.json({
        success: true,
...
router.put('/:id', auth_middleware_1.authenticateToken, role_middleware_1.requireTreeAccess, (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/care', auth_middleware_1.authenticateToken, role_middleware_1.requireTreeAccess, upload_middleware_1.uploadMiddleware.single('photo'), (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/adopt', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.post('/:id/transfer', auth_middleware_1.authenticateToken, (req, res) => {
    res.json({
        success: true,
...
router.get('/:id/care-logs', auth_middleware_1.optionalAuth, (req, res) => {
...
router.delete('/:id', auth_middleware_1.authenticateToken, role_middleware_1.requireTreeAccess, (req, res) => {
    res.json({
        success: true,
...
//# sourceMappingURL=tree.routes.js.map