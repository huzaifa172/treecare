      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-green-200 mb-4 max-w-md">
              Empowering sustainable tree care through AI technology. 
              Monitor, manage, and maintain your trees for a greener future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/trees" className="text-green-200 hover:text-white transition-colors">
                  Trees
                </Link>
              </li>
              <li>
                <Link href="/analytics" className="text-green-200 hover:text-white transition-colors">
                  Analytics
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-green-200 hover:text-white transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-green-800 mt-8 pt-8 text-center">
          <p className="text-green-300">
            © 2024 TreeCare. All rights reserved. Made with ❤️ for a greener planet.
          </p>
        </div>
      </div>
    </footer>
