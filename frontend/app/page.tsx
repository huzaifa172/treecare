...
// Animated Tree Component using CSS and SVG
function AnimatedTreeScene() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center justify-center h-full bg-gradient-to-br from-green-100 to-green-200 rounded-3xl">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-600 mx-auto mb-4"></div>
          <p className="text-green-700">Loading Scene...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-green-100 to-green-200 rounded-3xl overflow-hidden">
      {/* Animated Background */}
      ...
      >
        <div className="flex items-center space-x-2">
          <GiOakLeaf className="w-5 h-5 text-green-500" />
...
function TreeScene() {
  // Use the animated tree scene from above
  return <AnimatedTreeScene />;
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/map" className="text-gray-700 hover:text-green-600 transition-colors">Explore Map</Link>
              <Link href="/learn" className="text-gray-700 hover:text-green-600 transition-colors">Learn</Link>
            </div>

            <div className="flex items-center space-x-4">
              <Link href="/login" className="px-4 py-2 text-gray-700 hover:text-green-600 transition-colors">Login</Link>
              <Link href="/signup" className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">Get Started</Link>
            </div>
          </div>
        </div>
      </motion.nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div 
          style={{ y, opacity }}
          className="absolute inset-0 bg-gradient-to-br from-green-500/20 to-teal-500/20"
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">Own.</span>{' '}
                <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">Nurture.</span>{' '}
                <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">Impact.</span>
              </motion.h1>
              ...
              >
                <Link href="/signup" className="bg-green-600 text-white px-8 py-4 rounded-lg hover:bg-green-700 transition-all duration-300 hover:scale-105 flex items-center justify-center group">
                  Start Your Green Journey
                  <FiArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
                
                <button className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-lg hover:bg-green-600 hover:text-white transition-all duration-300 flex items-center justify-center group">
            ...
            >
              ...
              >
                <GiOakLeaf className="w-6 h-6 text-green-500" />
              </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our global community is making measurable environmental impact. See how your contribution matters.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="text-4xl font-bold text-green-600 mb-2">
                <AnimatedCounter end={456} suffix=" tons" />
              </div>
              <div className="text-gray-600">CO₂ Captured</div>
            </motion.div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup" className="bg-white text-green-600 font-semibold py-4 px-8 rounded-xl hover:bg-green-50 transition-all duration-300 hover:scale-105">
                Plant Your First Tree
              </Link>
              <Link href="/map" className="border-2 border-white text-white font-semibold py-4 px-8 rounded-xl hover:bg-white hover:text-green-600 transition-all duration-300">
                Explore the Map
              </Link>
            </div>
          </motion.div>
